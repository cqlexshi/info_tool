...
{@}{ifc}[dbtitle1]{||}={||}{|}{shw}数据库名为空，跳过此任务。{\@}{end}
                           {|}{\@}{sql}DB_Conn_CqBoss_online{\|}SET FOREIGN_KEY_CHECKS=0;
														    ...
														    {\|}1{\|}[dbtitle1]
{@}{-shw}=============EncTagTitle=============
{@}{jsr}des.js{||}utf-8{|}javascript{|}strEnc{||}[title],qiu7Wx,,
{@}{-shw}enc key word：[=]0[=]
...
{@}{-saf}cqboss_online_[tagid].htm
{@}{-cfl}cqboss_online_[tagid].htm{|}utf-8
{@}{clr}
{@}{cap}共 {?} 页
{@}{cap}newGridPK='{?}'
{@}{shw}  总页数：[=]0[=]  ;   PK值：[=]1[=]
{@}{lex}reg/boss_online/run1-2.lex{||}[tr_data]{-}[var_res]{|||}[tr_idx]{-}1{|||}[tagid2]{-}[tagid]{|||}[tr_title]{-}[title]{|||}[dbtitle2]{-}[dbtitle1]{|}utf-8{|}
{@}{shw} starting save data... 
...
{@}{for}2{||}[=]0[=]{|}{cug}http://boss.cqccn.com:18081/boss_web/gridturnpage?action=turnpage&pk=[=]1[=]&newpage=[foridx]{\|}
                       ...
                       {\@}{lex}reg/boss_online/run1-2.lex{\|\|}[tr_data]{-}[var_res]{\|\|\|}[tr_idx]{-}[foridx]{\|\|\|}[tagid2]{-}[tagid]{\|\|\|}[tr_title]{-}[title]{\|\|\|}[dbtitle2]{-}[dbtitle1]{\|}utf-8
                       {\@}{shw} step-1 : save page no.[foridx] ok.
                       {\@}{-shw} step-1 : waite 30 sec.
                       {\@}{-wtm}3000

{@}{sql}DB_Conn_CqBoss_online{|}update tasktag set done=1 where id=[tagid];{|}1{|}[=]1[=]
{@}{clr}