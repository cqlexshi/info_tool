...
{@}{dbr}DB_Conn_CqBoss_online
        {|}select id,title,dbtitle,done from tasktel where DoneTel=0 order by id limit 1{||}[Tag]{-}0
        {|}1
        {|}reg/boss_step/UserTel_Db.lex{|||}utf-8{||}[title1]{-}Title{||}[tagid1]{-}id{||}[dbtitle1]{-}dbtitle{||}[done1]{-}done
