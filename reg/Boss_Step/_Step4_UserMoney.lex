...
{@}{dbr}DB_Conn_CqBoss_online
        {|}select id,title,dbtitle,done from tasktag where DoneMoney=0 order by id limit 1{||}[Tag]{-}0
        {|}1
        {|}reg/boss_step/UserMoney_Db.lex{|||}utf-8{||}[title1]{-}Title{||}[tagid1]{-}id{||}[dbtitle1]{-}dbtitle{||}[done1]{-}done
